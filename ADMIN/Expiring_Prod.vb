...
Public Class Expiring_Prod
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RED_CHEESE_PIZZA.Expiring_Prod.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpiring_Prod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Expiring_Prod = New Expiring_Prod()
        rpt.Site = Me.Site
        Return rpt
    End Function
