...
Public Class Print_Raw_Mats
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RED_CHEESE_PIZZA.Print_Raw_Mats.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrint_Raw_Mats
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Print_Raw_Mats = New Print_Raw_Mats()
        rpt.Site = Me.Site
        Return rpt
    End Function
