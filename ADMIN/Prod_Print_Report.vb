...
Public Class Prod_Print_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RED_CHEESE_PIZZA.Prod_Print_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProd_Print_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Prod_Print_Report = New Prod_Print_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
