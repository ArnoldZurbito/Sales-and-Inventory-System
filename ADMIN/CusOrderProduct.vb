...
Public Class CusOrderProduct
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RED_CHEESE_PIZZA.CusOrderProduct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCusOrderProduct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CusOrderProduct = New CusOrderProduct()
        rpt.Site = Me.Site
        Return rpt
    End Function
