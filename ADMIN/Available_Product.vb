...
Public Class Available_Product
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RED_CHEESE_PIZZA.Available_Product.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAvailable_Product
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Available_Product = New Available_Product()
        rpt.Site = Me.Site
        Return rpt
    End Function
